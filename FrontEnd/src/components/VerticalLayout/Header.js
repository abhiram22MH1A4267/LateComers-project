            ...
            <div className="navbar-brand-box">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm">
                  <img src="logo1.png" alt="" height="22" />
                </span>
                <span className="logo-lg">
                  <img src="favicon.ico" alt="" height="17" />
                </span>
              </Link>

              <Link to="/" className="logo logo-light" style={{marginLeft: "-15px"}}>
                <span className="logo-sm">
                  <img src="favicon.ico" alt="" height="50" />
                </span>
                <span className="logo-lg" style={{marginLeft: "-15px"}}>
                  <img src="logo1.png" alt="" height="60" />
                </span>
              </Link>
            </div>
