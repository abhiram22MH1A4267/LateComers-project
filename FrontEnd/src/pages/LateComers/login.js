                                ...
                                <CardBody className="pt-0">
                                    ...
                                    <h3 className="text-center mt-5">
                                        <Link to="/" className="d-block auth-logo">
                                            <img src="login_logo.png" alt="" height="80" className="auth-logo-dark" />
                                            <img src="login_logo.png" alt="" height="80" className="auth-logo-light" />
                                        </Link>
                                    </h3>

                                    <div className="p-3 pt-0">
                                        {/* <h4 className="text-muted font-size-18 mb-1 text-center">Welcome Back !</h4> */}
                                        <p className="text-muted text-center">Sign in to continue to Late Comers.</p>
                                        <Form 
