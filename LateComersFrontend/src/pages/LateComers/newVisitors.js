...
// import imgggg from "./UniversityLogo.png"
...
function NewVisitors(props) {
        ...
        <body>
          <div class="print-container">
            ...
            <div class="header-details">
              ...
              <p id="inDate"><strong>Issued on:</strong> ${moment(new Date()).format("DD-MM-YYYY")}</p>
  ...
  //           <p><strong>In Time :</strong> ${FormData.inTime}</p>
  //           <div>
  //             <img src = "./UniversityLogo.png"/>
  //           </div>
  //         </div>
  ...
  //         <p><strong>Visitor Phone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.visitorPhone}</p>
  //         <p><strong>Coming From&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.visitorPlace}</p>
  //         <p><strong>No.of Visitors&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.visitorCount}</p>
  //         <p><strong>Vehicle No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.visitorVehicle}</p>
  //         <p><strong>Person To Meet&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.personToMeet}</p>
  //         <p><strong>Place to Go &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong>${FormData.placeToGo === "others" ? FormData.Others : FormData.placeToGo}</p>
  //         <p><strong>Purpose &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</strong> ${FormData.visitorPurpose}</p>
  //         <p><strong>Material with Visitor :</strong> ${FormData.visitorMaterial.length > 0 ? FormData.visitorMaterial : "No"}</p>
  //         <p class= "Acknowledgement"><strong>I/We have understood the briefing given to us on norms to be followed by us within the campus during our visit within the site</strong></p>
  //         <div class= "Signature-section">
  //           <div class= "Signatures">
  //             <div>Security Officer</div>
  ...
  // `;
    ...
    iframe.contentWindow.onafterprint = () => {
      console.log(printConfirmed)
      console.log("Print dialog closed");
      // axios.post("http://localhost:5000/api/add-Visitor", Data)
      // .then((result) => {
      ...
      console.log(printConfirmed)
      console.log("Visitor is added successfully")
      // Only call axios if print was confirmed
      // if (printConfirmed) {
      //   console.log("Print is Conformed")
