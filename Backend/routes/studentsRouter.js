...
const { collegeWiseStudentCount , collegeBranchDateData , branchWiseStudentCount , searchStudent , todayStudentData, addStudentInData , studentMonthlyReport, WeeklyReport , addStudentOutData ,todayStudentInData ,todayStudentOutData , getBranches   } = require("../controllers/studentsController")
...
Router.get("/today-Student-Data/:college/:branch", todayStudentData)
